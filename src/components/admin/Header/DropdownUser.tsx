        ...
        >
          <ul className="flex flex-col gap-5 border-b border-stroke px-3 py-3 dark:border-strokedark">
            <li>
              <Link
                href="/profile"
                className="flex items-center gap-1 text-sm font-medium duration-300 ease-in-out hover:text-black lg:text-base text-black"
              >
            ...
            <li>
              ...
              >
                <Image width={24} height={25} src={LogoutImage} alt="logout" />
                Logout
              </button>
            </li>
          </ul>
