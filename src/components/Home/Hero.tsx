        ...
        <>
            <div className='md:py-44 py-32 max-w-[90%] mx-auto'>
                ...
                <div className='my-10 flex justify-center'>
                    <Link href="#" className='bg-[#266CA8] text-white rounded-full mt-2 flex justify-center h-[10%] px-3 py-4 md:w-[20%] p-5 font-medium md:text-2xl text-xl'>Try LumaShape Now</Link>
                </div>
