        ...
        <>
            <div className='md:py-36 py-32 max-w-[90%] mx-auto' id='home'>
                ...
                <div className='my-10 flex justify-center'>
                    <Link href="#" className='bg-[#266CA8] text-white rounded-full mt-2 flex justify-center h-[10%] px-3 py-4 text-center p-5 font-medium md:text-2xl text-xl'>Try LumaShape Now</Link>
                </div>
