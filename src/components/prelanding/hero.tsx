          ...
          <div className="flex flex-col gap-20 items-start justify-center  z-10 ">
            <div className="flex lg:flex-row flex-col relative z-10 h-full md:gap-20 gap-5">
              <div className="lg:w-1/2">
                ...
                <p className="font-medium md:text-xl text-lg text-[#00000066]  max-w-[559px] my-5">
          ...
          <div className="flex flex-col justify-center mt-10">
            ...
            <div className="flex items-start mt-3 gap-2 mb-5">
              <Image
                ...
                height={20}
              />
              <p className="md:text-2xl text-xl font-semibold  flex flex-col gap-2">
                Upload Your Image
                <p className="font-medium md:text-xl text-lg text-[#00000066]  ">
            ...
            <div className="flex items-start my-3 gap-2 mb-5">
              ...
              <p className="text-2xl font-semibold flex flex-col gap-2">
                Preview DXF File
                <p className="font-medium text-xl text-[#00000066]  ">
            ...
            <div className="flex items-start gap-2 mb-5">
              <Image
                ...
                height={20}
              />
              <p className="md:text-2xl text-xl font-semibold mb-2  flex flex-col gap-2">
                Download & Save
                <p className="font-medium md:text-xl text-lg text-[#00000066]  ">
