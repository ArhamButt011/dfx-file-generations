        ...
        <div className=' max-w-[1328px] mx-auto' id='benefits' >
            ...
            <div className="flex md:flex-row flex-col pt-20 justify-between items-start ">
                ...
                <motion.div
                    ...
                    <p className='text-center text-[#00000066] text-[21px] mx-auto font-medium max-w-[80%]'>Generate ready-to-cut DXF files of the exact tool layout shown in the input image, perfectly sized to fit specified drawer dimensions. Or scan individual tools to import into CAD and create custom layouts</p>
                </motion.div>
                {/* access Anytime */}
                <motion.div
                    className='flex flex-col items-center md:mt-0 mt-10 md:w-1/3'
