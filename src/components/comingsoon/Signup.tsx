  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-[90%] md:max-w-[1328px]">
        <h1 className="mt-6 mb-2 font-bold text-[20px] md:text-[32px] text-center leading-[30.3px] md:leading-[40.2px]">
          Get Updated Or Support New Ideas!!
        </h1>
        <p className="mx-auto max-w-[700px] font-medium text-[#00000066] text-[14px] md:text-[16px] text-center">
