                        ...
                        <tbody>
                            {downloads.map((data: Downloads, index) => (
                                <tr key={index} className="text-[22px]">
                                    ...
                                    <td className={`py-3 px-4 text-center text-lg font-medium ${index === downloads.length - 1 ? 'rounded-br-3xl border-0' : 'border-r'}`}>
                                        <div className="flex justify-center items-center gap-3">
                                            ...
                                            <span className='cursor-pointer' onClick={() => handleDownloadDXF(data.file_url)}>
