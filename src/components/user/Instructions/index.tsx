                  ...
                  <ul className="list-none mb-4 mt-1">
                    <li className="font-medium">
                      <Text as="p1" className="text-[#00000080]">
                        ...
                        for scaling. There&apos;s no tracing or CAD work
                        involved.
                      </Text>
                      <Text as="p1" className="mt-5 text-[#00000080]">
                        Once the image is uploaded, Lumashape does the rest:
                        detecting each object&apos;s shape, scaling it
                        accurately, and preserving its position in the layout.
                        The result is a cut-ready DXF that reflects your
                        original arrangement, with options to fine-tune fit, add
                        clearance cuts, define boundaries, and label drawers.
                      </Text>
                    </li>
                  </ul>
                </li>
