  ...
  return (
    <div className="mt-10 border-b border-[#000000]">
      ...
      <ul className="list-disc text-[#00000080] ml-6">
        ...
        <li>Capture photos from a maximum distance of 4 feet</li>
        <li>
          Be mindful of camera angle and the parallax effect. Contours are based
          on the photo&apos;s perspective—taller, off-center objects may appear
          distorted. For best accuracy, photograph tall objects individually
          from directly above.
        </li>
      </ul>
      ...
      <ul className="list-disc text-[#00000080] ml-6 mt-7 pb-16">
        ...
        <li>Use consistent lighting with minimal shadows.</li>
        <li>All objects must rest on the same flat surface.</li>
        <li>
        ...
        <li>
          ...
          objects and the edges of the container. This ensures clean separation
