...
const CustomInputs = forwardRef<
  HTMLDivElement,
  {
    fingerClearanceRef: React.RefObject<HTMLDivElement | null>
    contourOffsetRef: React.RefObject<HTMLDivElement | null>
    boundaryContourRef: React.RefObject<HTMLDivElement | null>
    boundaryDimensionRef: React.RefObject<HTMLDivElement | null>
    drawerIdRef: React.RefObject<HTMLDivElement | null>
  }
>(
  (
    {
    ...
    return (
      <div className="mt-10" ref={ref}>
        ...
        <div ref={fingerClearanceRef}>
          <ul className="list-disc pl-5 mb-2 ml-[6px]">
            <li>
              <Text as="h4">Finger Clearance</Text>
            </li>
          </ul>
        </div>
        ...
        <ul className="list-disc text-[#00000080] ml-6">
          <li>
            <Text as="p1">
              Optional: defines a boundary around your layout.
            </Text>
          </li>
          <li>
            <Text as="p1">Units selectable (mm/inches).</Text>
          ...
          <li>
            <Text as="p1">
              ...
              layout and the entered boundary dimensions. If the layout exceeds
              the boundary limits, the software will display an error.
            </Text>
          </li>
        </ul>
