    ...
    <>
      ...
      <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
        ...
        >
          ...
          <svg
            style={{ transform: dropdownOpen ? 'rotate(360deg)' : 'rotate(270deg)' }}
          ...
          {dropdownOpen && (
            ...
            >
              ...
              <ul className="flex flex-col border-t border-gray-300 gap-4 px-6 py-6">
                ...
                <li className="flex items-center gap-2 text-sm font-medium duration-300 ease-in-out hover:text-[#266CA8] lg:text-base"
      ...
      <Modal isOpen={isDeleteOpen} onClose={onEditClose} buttonContent="">
        ...
        <div className="flex items-center flex-col gap-10">
          ...
          <div className="relative flex flex-col items-center">
            ...
            <p className='text-center text-[#777777] font-medium text-2xl'>Are you sure you want to delete your account? All your downloaded files and subscription data will be lost</p>
          </div>

          <div className="w-full flex gap-10">
            <button onClick={() => setIsDeleteOpen(false)} className="font-normal text-[#266CA8] border border-[#266CA8] text-[24.56px] bg-white rounded-full p-5  w-full">
              Cancel
            </button>
            <button onClick={handleDelete} className="font-normal text-white text-[24.56px] bg-[#266CA8] rounded-full p-5  w-full">
              Yes I&apos;m Sure
            </button>
          </div>
        </div>
