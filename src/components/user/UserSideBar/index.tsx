  ...
  return (
    <>
      ...
      <ClickOutside onClick={() => setSidebarOpen(false)}>
        <aside
          className={`fixed left-0 top-0 lg:z-9999 z-9999 flex min-h-screen max-h-auto md:w-72.5 w-full flex-col overflow-y-auto bg-[#F8F8F8] duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
            }`}
        >
                      ...
                      <ul className="flex flex-col border-t border-gray-300 gap-3 px-6 py-5">
                        <li>
                          <Link
                            ...
                            onClick={() => { handleEditClick(); setSidebarOpen(false) }}
                          >
                        ...
                        <li>
                          <Link
                            href="#"
                            className="flex items-center gap-2 text-sm font-medium duration-300 ease-in-out hover:text-[#266CA8] lg:text-base"
                            onClick={() => { handleChangePassword(); setSidebarOpen(false) }}
                          >
                        ...
                        <li>
                          <Link
                            href="#"
                            className="flex items-center gap-2 text-sm font-medium duration-300 ease-in-out hover:text-[#266CA8] lg:text-base"
                            onClick={() => { setIsDeleteOpen(true); setSidebarOpen(false) }}
                          >
                            <svg width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <form onSubmit={handleSubmit1}>
          <div className="flex items-center flex-col gap-10">
            ...
            <div className="w-full mt-24">
              <button type='submit' className="font-normal text-white text-[24.56px] bg-[#266CA8] rounded-full px-16 py-3 w-full">
                Continue
              </button>
            </div>
          </div>
      ...
      <Modal isOpen={isDeleteOpen} onClose={onEditClose} buttonContent="">
        ...
        <div className="flex items-center flex-col gap-10">
          ...
          <div className="relative flex flex-col items-center">
            ...
            <p className='text-center text-[#777777] font-medium text-sm'>Are you sure you want to delete your account? All your downloaded files and subscription data will be lost</p>
          </div>

          <div className="w-full flex gap-10">
            <button onClick={() => setIsDeleteOpen(false)} className="font-normal text-[#266CA8] border border-[#266CA8] text-[14px] bg-white rounded-full p-5  w-full">
              Cancel
            </button>
            <button onClick={handleDelete} className="font-normal text-white text-[14.56px] bg-[#266CA8] rounded-full p-5  w-full">
              Yes I&apos;m Sure
            </button>
          </div>
        </div>
